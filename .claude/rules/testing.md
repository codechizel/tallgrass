...
- `tests/test_common_space.py` — global roster, bridge matrix, simultaneous alignment (known-answer recovery), transform scores, quality gates (separation, sign flip), polarization trajectory, edge cases (~18 tests)
