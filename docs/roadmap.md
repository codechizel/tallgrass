...
| 28 | Common Space Ideal Points | 2026-03-24 | Cross-temporal alignment: simultaneous affine linking of canonical ideal points across all 14 bienniums (78th-91st) via bridge legislators (GLS 1999 approach). Bootstrap uncertainty, quality gates (party separation + sign consistency), polarization trajectory. 133-145 bridge legislators per adjacent pair; 3 end-to-end (Ballard, Haley, Helgerson). Design: `analysis/design/common_space.md`, article: `docs/common-space-ideal-points.md`, ADR-0119. |
