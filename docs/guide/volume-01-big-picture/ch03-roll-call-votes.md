...
But this high base rate creates a trap for naive analysis. If someone tells you that two legislators "agree 90% of the time," that sounds impressive — until you realize that two legislators who voted randomly (flipping a coin weighted 82% toward Yea) would agree about 70% of the time just by chance. (Why 70%? Because both independently vote Yea 82% of the time, so they'll both vote Yea on the same bill 0.82 × 0.82 = 67% of the time, and both vote Nay 0.18 × 0.18 = 3% of the time — that's 70% agreement with zero coordination.) The 90% agreement is only 20 percentage points above what you'd expect from pure chance.
