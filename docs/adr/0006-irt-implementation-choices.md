...
- 2026-03-07: Expanded Decision 2 from a single strategy (PCA anchors) to a 7-strategy identification system with auto-detection. PCA anchors remain the default for balanced chambers; supermajority chambers auto-select agreement-based anchors or sort constraints. CLI `--identification` flag allows manual override. See ADR-0103 and `docs/irt-identification-strategies.md`.
