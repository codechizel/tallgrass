...
Only PCA-informed initialization resolved the problem. See `results/experimental_lab/2026-02-23_irt-convergence-mode-splitting/irt-convergence-investigation.md` for the full write-up.
...
See `results/experimental_lab/2026-02-23_irt-convergence-mode-splitting/lit-review-irt-initialization.md` for the full literature review.
