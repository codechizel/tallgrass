...
Verifies ExperimentConfig defaults and immutability, and compute_pca_initvals()
with synthetic data. The run_experiment() orchestrator is not unit-tested here
(it requires MCMC sampling).
