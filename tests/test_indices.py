...
def _contested_votes() -> pl.DataFrame:
    ...
    return pl.DataFrame([
        # rc1 — contested
        ("rc1", "rep_a", "Yea"), ("rc1", "rep_b", "Yea"),
        ("rc1", "rep_c", "Yea"), ("rc1", "rep_d", "Yea"),
        ("rc1", "rep_e", "Nay"),
        ("rc1", "dem_x", "Nay"), ("rc1", "dem_y", "Nay"), ("rc1", "dem_z", "Nay"),
        # rc2 — contested
        ("rc2", "rep_a", "Yea"), ("rc2", "rep_b", "Yea"),
        ("rc2", "rep_c", "Yea"), ("rc2", "rep_d", "Yea"),
        ("rc2", "rep_e", "Yea"),
        ("rc2", "dem_x", "Nay"), ("rc2", "dem_y", "Nay"), ("rc2", "dem_z", "Yea"),
        # rc3 — unanimous
        ("rc3", "rep_a", "Yea"), ("rc3", "rep_b", "Yea"),
        ("rc3", "rep_c", "Yea"), ("rc3", "rep_d", "Yea"),
        ("rc3", "rep_e", "Yea"),
        ("rc3", "dem_x", "Yea"), ("rc3", "dem_y", "Yea"), ("rc3", "dem_z", "Yea"),
    ], schema=["vote_id", "legislator_slug", "vote"], orient="row")
...
def _contested_legislators() -> pl.DataFrame:
    return pl.DataFrame({
        "slug": ["rep_a", "rep_b", "rep_c", "rep_d", "rep_e",
                 "dem_x", "dem_y", "dem_z"],
...
class TestComputeUnityAndMaverick:
    ...
    def test_unity_output_columns(self):
        ...
        expected = {"legislator_slug", "party", "votes_with_party",
                    "party_votes_present", "unity_score", "maverick_rate", "session"}
    ...
    def test_maverick_output_columns(self):
        ...
        expected = {"legislator_slug", "party", "maverick_rate", "weighted_maverick",
                    "n_defections", "loyalty_zscore"}
    ...
    def test_no_party_votes_returns_empty(self):
        ...
        votes = pl.DataFrame([
            ("rc1", "rep_a", "Yea"), ("rc1", "dem_x", "Yea"),
        ], schema=["vote_id", "legislator_slug", "vote"], orient="row")
        rollcalls = pl.DataFrame({
            "vote_id": ["rc1"], "chamber": ["House"],
            "vote_date": ["01/15/2025"], "motion": ["Final Action"],
            "bill_number": ["HB 1"],
        })
        legs = pl.DataFrame({
            "slug": ["rep_a", "dem_x"],
...
class TestComputeENPPerVote:
    ...
    def test_output_columns(self):
        result = compute_enp_per_vote(
            _contested_votes(), _contested_rollcalls(),
            _contested_legislators(), "House", "test"
        )
    ...
    def test_single_party_chamber(self):
        ...
        rollcalls = pl.DataFrame({
            "vote_id": ["rc1"], "chamber": ["House"],
            "vote_date": ["01/15/2025"], "motion": ["FA"],
            "bill_number": ["HB 1"],
        })
        legs = pl.DataFrame({
...
class TestFindFracturedVotes:
    ...
    def test_fractured_when_split(self):
        ...
        votes = pl.DataFrame([
            ("rc1", "rep_a", "Yea"), ("rc1", "rep_b", "Nay"),
            ("rc1", "rep_c", "Yea"), ("rc1", "rep_d", "Nay"),
            ("rc1", "dem_x", "Nay"), ("rc1", "dem_y", "Nay"),
        ], schema=["vote_id", "legislator_slug", "vote"], orient="row")
        rollcalls = pl.DataFrame({
            "vote_id": ["rc1"], "chamber": ["House"],
            "vote_date": ["01/15/2025"], "motion": ["FA"],
    ...
    def test_empty_rice_returns_empty(self):
        ...
        empty = pl.DataFrame({
            "vote_id": [], "party": [], "yea_count": [], "nay_count": [],
            "total_voters": [], "rice_index": [],
        }).cast({"yea_count": pl.Int64, "nay_count": pl.Int64,
                 "total_voters": pl.Int64, "rice_index": pl.Float64})
...
class TestComputeCoDefectionMatrix:
    ...
    def test_no_shared_defections_returns_none(self):
        ...
        result = compute_co_defection_matrix(
            defection_sets, maverick, "House", "test"
        )
...
class TestComputeCareyUnity:
    ...
    def test_formula_correctness(self):
        ...
        rc3_r = result.filter(
            (pl.col("vote_id") == "rc3") & (pl.col("party") == "Republican")
        )
    ...
    def test_output_columns(self):
        ...
        expected = {"vote_id", "party", "carey_unity", "yea_count", "nay_count",
